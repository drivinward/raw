(function () {
  ...
  chart.draw(function (selection, data) {
    ...
    data.forEach(function (item, index) {
      ...
      const translationGroup = barchart.append("g")
        .attr("transform", `translate(${w / 2}, ${(h / 2) + titleSpace})`)

      const rotatedBar = translationGroup.selectAll("g")
        .data(item.values)
        .enter().append("g")
        .attr("transform", (d, i, a) => `rotate(${(360 / a.length) * i})`)


      // Draw the bars
      rotatedBar.append("rect")
        .attr("class", "bar")
        .attr("width", (d, i, a) => (360 / a.length) - xPadding())
        .attr("x", (d, i, a) => (- (360 / a.length) / 2) + xPadding() / 2)
      ...
      // // debug sh*t
      // translationGroup.append("circle")
      //   .attr("cx", 0)
      //   .attr("cy", 0)
      //   .attr("r", 2)
      //   .attr("fill", "red")

      // rotatedBar.append("line")
      //   .attr("class", "line")
      //   .attr("x1", 0)
